...
**TSUN Local** integreert compatibele TSUN-micro-omvormers rechtstreeks via het lokale netwerk in Home Assistant, zonder proxy of cloudservice. Versie 1.1.3 ondersteunt de gevalideerde **TSOL-MP3000** en biedt eerste ondersteuning voor **GEN3**, **GEN3 PLUS** en andere **TITAN**-modellen die nog op echte hardware moeten worden gevalideerd.
...
| GEN3 / GEN3 PLUS | **MX450, MX500, MX1000** | ❌ Validatie in afwachting |
...
Het lokale protocol wordt automatisch gedetecteerd wanneer het apparaat wordt toegevoegd.
