...
<p align="center">Direkter lokaler Zugriff auf kompatible TSUN-Mikrowechselrichter in Home Assistant.<br><strong>1.6.1</strong></p>
...
Aktuelle Versionen: GUI **1.5.12** · Dump-Engine **2.8.2**.
