...
<p align="center">Acceso local directo a microinversores TSUN compatibles en Home Assistant.<br><strong>1.6.1</strong></p>
...
Versiones actuales: GUI **1.5.12** · motor de dump **2.8.2**.
