...
<p align="center">Accès local direct aux micro-onduleurs TSUN compatibles dans Home Assistant.<br><strong>1.5.1-beta.3</strong></p>
...
La 1.5.1-beta.3 conserve la présentation et le fonctionnement de la 1.5.0, tout en ajoutant les dernières découvertes MP3000 en **lecture seule**.
