...
<p align="center">在 Home Assistant 中直接本地访问兼容的 TSUN 微型逆变器。<br><strong>1.4.0-beta.8</strong></p>
...
> **社区贡献：** **TheSmartGerman** 通过真实硬件测试和兼容性反馈，为 1097 支持作出了贡献。
...
实验性的 1097 映射参考了 **Stefan Allius / `s-allius/tsun-gen3-proxy`** 的公开协议研究，并针对 TSUN Local 的直接本地使用进行了适配。
