...
class MetadataTests(unittest.TestCase):
    ...
    def test_public_site_links_visual_entity_reference(self) -> None:
        ...
        self.assertIn("Sunology PLAY2 validated · 1.5.3 clear-text alarms", index)
        self.assertIn("Sunology PLAY2", index)
        self.assertIn("Sunology Play 2", index)
        self.assertIn("clear-text alarms", index)
        ...
        self.assertIn("Clear-text alarms", entities)
        ...
        self.assertEqual(sitemap.count("<lastmod>2026-08-26</lastmod>"), 2)
