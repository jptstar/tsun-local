...
**TSUN Local** 可通过本地网络将兼容的 TSUN 微型逆变器直接接入 Home Assistant，无需代理服务器或云服务。版本 1.1.3 支持已在真实设备上验证的 **TSOL-MP3000**，并为 **GEN3**、**GEN3 PLUS** 及其他 **TITAN** 型号提供初步支持，这些型号仍等待真实硬件验证。
...
| GEN3 / GEN3 PLUS | **MX450, MX500, MX1000** | ❌ 等待验证 |
